...
namespace NaviGoApi.API.Controllers
{
	...
	public class ShipmentStatusHistoryController : ControllerBase
	{
		...
		public async Task<IActionResult> GetAll()
		{
			...
			return Ok(new { message = "Shipment status histories retrieved successfully.", data = histories });
		}
		...
		public async Task<IActionResult> GetById(int id)
		{
			...
			return Ok(new { message = "Shipment status history retrieved successfully.", data = history });
		}
