	...
	public class PaymentMongoRepository : IPaymentRepository
	{
		...
		public async Task DeleteAsync(Payment payment)
		{
			...
			if (result.DeletedCount == 0)
				throw new KeyNotFoundException($"Payment with Id {payment.Id} not found for deletion.");
		}
		...
		public async Task UpdateAsync(Payment payment)
		{
			...
			if (result.MatchedCount == 0)
				throw new KeyNotFoundException($"Payment with Id {payment.Id} not found for update.");
		}
