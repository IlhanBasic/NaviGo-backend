	...
	namespace NaviGoApi.Infrastructure.Neo4j.Repositories
	{
		...
		public async Task AddAsync(Shipment shipment)
		{
			if (shipment.Id == 0)
			{
				shipment.Id = await GetNextIdAsync("Shipment");
			}

			// Ako je ContractId 0, zameni sa ispravnim ID (ako postoji)
			if (shipment.ContractId == 0 && shipment.Contract != null)
			{
				shipment.ContractId = shipment.Contract.Id;
			}
