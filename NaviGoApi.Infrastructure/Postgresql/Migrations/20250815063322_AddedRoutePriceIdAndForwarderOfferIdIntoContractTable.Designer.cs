...
namespace NaviGoApi.Infrastructure.Migrations
{
    ...
    [Migration("20250815063322_AddedRoutePriceIdAndForwarderOfferIdIntoContractTable")]
    partial class AddedRoutePriceIdAndForwarderOfferIdIntoContractTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("NaviGoApi.Domain.Entities.Contract", b =>
                {
                    ...
                    b.Property<int>("ForwarderOfferId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("NaviGoApi.Domain.Entities.Contract", b =>
                {
                    ...
                    b.HasOne("NaviGoApi.Domain.Entities.ForwarderOffer", "ForwarderOffer")
                        .WithMany()
                        .HasForeignKey("ForwarderOfferId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                    ...
                    b.HasOne("NaviGoApi.Domain.Entities.RoutePrice", "RoutePrice")
                        .WithMany()
